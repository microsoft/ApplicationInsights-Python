...
.. code-block:: python
    ...
    from azure.monitor.opentelemetry.vendor.opentelemetry.instrumentation.dbapi import trace_integration
...
from azure.monitor.opentelemetry.vendor.opentelemetry.instrumentation.dbapi.version import (
    __version__,
)
