...
.. code-block:: python
    ...
    from azure.monitor.opentelemetry.vendor.opentelemetry.instrumentation.wsgi import OpenTelemetryMiddleware
...
from azure.monitor.opentelemetry.vendor.opentelemetry.instrumentation.wsgi.version import (
    __version__,
)
