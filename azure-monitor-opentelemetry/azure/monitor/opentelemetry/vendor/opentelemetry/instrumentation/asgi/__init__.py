...
.. code-block:: python
    ...
    from azure.monitor.opentelemetry.vendor.opentelemetry.instrumentation.asgi import OpenTelemetryMiddleware
...
from azure.monitor.opentelemetry.vendor.opentelemetry.instrumentation.asgi.version import (
    __version__,
)  # noqa
