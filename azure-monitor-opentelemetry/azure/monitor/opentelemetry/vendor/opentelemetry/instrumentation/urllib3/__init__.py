...
.. code-block:: python
    ...
    import urllib3
    from azure.monitor.opentelemetry.vendor.opentelemetry.instrumentation.urllib3 import URLLib3Instrumentor
...
from azure.monitor.opentelemetry.vendor.opentelemetry.instrumentation.urllib3.version import (
    __version__,
)
