...
.. code:: python
    ...
    from azure.monitor.opentelemetry.vendor.opentelemetry.instrumentation.psycopg2 import Psycopg2Instrumentor
...
from azure.monitor.opentelemetry.vendor.opentelemetry.instrumentation import (
    dbapi,
)
...
from azure.monitor.opentelemetry.vendor.opentelemetry.instrumentation.psycopg2.version import (
    __version__,
)
