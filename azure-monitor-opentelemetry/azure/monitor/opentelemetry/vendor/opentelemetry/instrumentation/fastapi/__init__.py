...
.. code-block:: python
    ...
    import fastapi
    from azure.monitor.opentelemetry.vendor.opentelemetry.instrumentation.fastapi import FastAPIInstrumentor
...
from azure.monitor.opentelemetry.vendor.opentelemetry.instrumentation.asgi import (
    OpenTelemetryMiddleware,
)
from azure.monitor.opentelemetry.vendor.opentelemetry.instrumentation.fastapi.package import (
    _instruments,
)
from azure.monitor.opentelemetry.vendor.opentelemetry.instrumentation.fastapi.version import (
    __version__,
)
