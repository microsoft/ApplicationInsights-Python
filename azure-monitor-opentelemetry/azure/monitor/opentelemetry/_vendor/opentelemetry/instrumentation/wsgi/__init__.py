...
from azure.monitor.opentelemetry._vendor.opentelemetry.instrumentation.wsgi.version import (
    __version__,
)
...
# TODO: inherit from azure.monitor.opentelemetry._vendor.opentelemetry.instrumentation.propagators.Setter
