...
from azure.monitor.opentelemetry._vendor.opentelemetry.instrumentation import (
    dbapi,
)
...
from azure.monitor.opentelemetry._vendor.opentelemetry.instrumentation.psycopg2.version import (
    __version__,
)
