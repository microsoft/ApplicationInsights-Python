...
from azure.monitor.opentelemetry._vendor.opentelemetry.instrumentation.environment_variables import (
    OTEL_PYTHON_DISABLED_INSTRUMENTATIONS,
)
from azure.monitor.opentelemetry._vendor.opentelemetry.instrumentation.utils import (
    _python_path_without_directory,
)
from azure.monitor.opentelemetry._vendor.opentelemetry.instrumentation.version import (
    __version__,
)
