...
from azure.monitor.opentelemetry._vendor.opentelemetry.instrumentation.dbapi.version import (
    __version__,
)
from azure.monitor.opentelemetry._vendor.opentelemetry.instrumentation.sqlcommenter_utils import (
    _add_sql_comment,
)
