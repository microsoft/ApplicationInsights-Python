...
class TestJoinableAsynchronousQueue(unittest.TestCase):
    def test_construct(self):
        queue = channel.AsynchronousQueue(MockJoinableAsynchronousSender())
...
class MockJoinableAsynchronousSender:
    def __init__(self):
